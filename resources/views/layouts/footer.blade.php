                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="{{asset('images/logo/logoAlexa.png')}}"
                                        alt=""><img class="dark-footer-logo" src="{{asset('images/logo/logoAlexa.png')}}"
                    ...
                    <div class="col text-center footer-copy">
                        <div class="footer-bottom-copy ">
                            <div class="ec-copy">Copyright © {{date('Y')}} <a class="site-name text-upper"
                                    href="#">Electromuebles Alexa<span>.</span></a>. Todos los derechos reservados</div>
                        </div>
                    </div>
