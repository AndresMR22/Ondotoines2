...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Ventas a credito</li>
      </ol>
    </nav>
  </div>
  <div class="card">
                   ...
                   <td>
                    <form method="post" id="deletecategoria{{$venta->id}}" action="{{url('admin/categoria/'.$venta->id)}}" class="d-inline">
                      ...
                      {{method_field('DELETE')}}
                          ...
                          <a href="{{route('venta.detalleVenta',$venta->id)}}" id="botoncol" class="btn btn-outline-primary " title ="Ver detalles de la venta"><i class="fas fa-cart-plus"></i></a>
                        </form>
                      </td>
