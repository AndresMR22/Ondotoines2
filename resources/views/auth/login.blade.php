...
<body>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{asset('images/logo/logo.png')}}" alt="Site Logo" /><img
                                        class="dark-logo" src="{{asset('images/logo/dark-logo.png')}}" alt="Site Logo"
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('images/product-image/6_1.jpg')}}" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('images/product-image/12_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
    ...
    <!-- Ec breadcrumb start -->
@include('layouts.breadcrumb',["pagina"=>"Iniciar sesión"])
    <!-- Ec breadcrumb end -->
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Iniciar sesión</h2>
                        <h2 class="ec-title">Iniciar sesión</h2>
                        <p class="sub-title mb-3">El mejor lugar para comprar tus productos del hogar</p>
                    </div>
                </div>
                        ...
                        <div class="ec-login-form">
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <span class="ec-login-wrap">
                                    ...
                                    <input type="text" name="email" value="{{ old('email') }}" class="@error('email') is-invalid @enderror" autocomplete="email"  placeholder="Ingrese su correo..." required />
                                    @error('email')
                                ...
                                <span class="ec-login-wrap">
                                    ...
                                    <input type="password" name="password" class="@error('password') is-invalid @enderror"  autocomplete="current-password" placeholder="Ingrese su contraseña" required />
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
