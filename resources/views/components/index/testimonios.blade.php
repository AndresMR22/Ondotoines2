        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="section-title mb-0">
                    ...
                    <p class="sub-title mb-3">Que opinan los clientes sobre nosotros</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="ec-test-outer">
                <ul id="ec-testimonial-slider">
                    <li class="ec-test-item">
                        <img src="{{asset('images/testimonial/top-quotes.svg')}}" class="svg_img test_svg top" alt="" />
                        <div class="ec-test-inner">
                            <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                    src="{{asset('images/testimonial/1.jpg')}}" /></div>
                        ...
                        <img src="{{asset('images/testimonial/bottom-quotes.svg')}}" class="svg_img test_svg bottom"
                            alt="" />
                    </li>
                    <li class="ec-test-item ">
                        <img src="{{asset('images/testimonial/top-quotes.svg')}}" class="svg_img test_svg top" alt="" />
                        <div class="ec-test-inner">
                            <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                    src="{{asset('images/testimonial/2.jpg')}}" /></div>
                            <div class="ec-test-content">
                                <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                    typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                    ever since the 1500s, when an unknown printer took a galley of type and
                    ...
                    <li class="ec-test-item">
                        ...
                        <div class="ec-test-inner">
                            <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                    src="{{asset('images/testimonial/3.jpg')}}" /></div>
                            <div class="ec-test-content">
                                <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                    typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                    ever since the 1500s, when an unknown printer took a galley of type and
